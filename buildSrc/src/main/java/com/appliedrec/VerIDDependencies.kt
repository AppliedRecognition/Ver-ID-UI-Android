...
object VerIDDependencies {
    ...
    const val LIVENESS_DETECTION = "com.appliedrec.livenessdetection:common:1.0.0"
    const val SPOOF_DEVICE_DETECTION = "com.appliedrec.livenessdetection:spoof-device-detection:1.0.0"
    const val SPOOF_DEVICE_DETECTION_MODELS = "com.appliedrec.livenessdetection:spoof-device-detection-models:1.0.0"
