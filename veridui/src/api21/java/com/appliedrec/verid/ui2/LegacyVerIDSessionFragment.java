...
public class LegacyVerIDSessionFragment extends Fragment implements IVerIDSessionFragment, ICameraPreviewView.CameraPreviewViewListener, Camera.PreviewCallback {
    ...
    public void startCamera() {
        ...
        previewProcessingExecutor.execute(() -> {
            try {
                ...
                runOnUIThread(LegacyVerIDSessionFragment.this::setupCamera);
            } catch (final Exception e) {
                runOnUIThread(() -> {
                    if (delegate != null) {
                        delegate.veridSessionFragmentDidFailWithError(LegacyVerIDSessionFragment.this, e);
                    }
                });
            }
        });
